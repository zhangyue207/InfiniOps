...
class MhaVarlenFwd : public Operator<MhaVarlenFwd> {
 public:
  MhaVarlenFwd(const Tensor q, const Tensor k, const Tensor v,
               ...
               std::optional<int64_t> gen = std::nullopt,
    ...
    assert(out.has_value() &&
           "`MhaVarlenFwd` requires `out`; InfiniOps does not allocate output "
           "tensors");
  ...
  virtual void operator()(
      ...
      bool return_softmax, std::optional<int64_t> gen = std::nullopt,
